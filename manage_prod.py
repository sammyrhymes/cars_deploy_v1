...
env_file_path = os.path.join(current_dir, '.env.prod')  # Path to the .env.dev file in the same directory as manage_dev.py
...
def main():
    ...
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'cars_competition.settings.production')
    try:
