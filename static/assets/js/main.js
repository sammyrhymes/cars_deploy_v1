...
//   document.getElementById('addToBasketPopup').style.display = 'flex'; // Show the pop-up
// });
...
//     document.getElementById('ticketInput').value = this.dataset.tickets;
//   });
// });

// // Close pop-up
// document.getElementById('addToBasket').addEventListener('click', function () {
//   // Add logic to handle adding tickets to the basket
//   document.getElementById('addToBasketPopup').style.display = 'none'; // Hide the pop-up
// });